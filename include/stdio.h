...
_PROTOTYPE( int vfprintf, (FILE *_stream, const char *_format, va_list arg)	);
_PROTOTYPE( int vprintf, (const char *_format, va_list arg)		);
_PROTOTYPE( int vsprintf, (char *_s, const char *_format, va_list arg)	);
...
_PROTOTYPE( int vfscanf, (FILE *_stream, const char *_format, va_list arg));
_PROTOTYPE( int vscanf, (const char *_format, va_list arg)		);
_PROTOTYPE( int vsscanf, (const char *_s, const char *_format, va_list arg));
...
_PROTOTYPE(int vsnprintf, (char *_s, size_t _n, const char *_format, va_list arg)	);
#endif
