...
#if (_MINIX_CHIP == _CHIP_ARM)
#define sc_retreg sc_regs.sr_retreg
#define sc_r1 sc_regs.sr_r1
#define sc_r2 sc_regs.sr_r2
#define sc_r3 sc_regs.sr_r3
#define sc_r4 sc_regs.sr_r4
#define sc_r5 sc_regs.sr_r5
#define sc_r6 sc_regs.sr_r6
#define sc_r7 sc_regs.sr_r7
#define sc_r8 sc_regs.sr_r8
#define sc_r9 sc_regs.sr_r9
#define sc_r10 sc_regs.sr_r10
#define sc_r11 sc_regs.sr_r11
#define sc_r12 sc_regs.sr_r12
#define sc_sp sc_regs.sr_sp
#define sc_pc sc_regs.sr_pc
#define sc_psw sc_regs.sr_psw
#endif /* _MINIX_CHIP == _CHIP_ARM */
