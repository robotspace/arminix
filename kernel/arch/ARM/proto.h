...
_PROTOTYPE( unsigned int read_cpu_flags, (void)                        );
...
_PROTOTYPE( unsigned int read_cp15, (unsigned int reg, unsigned int operant2));
_PROTOTYPE( void write_cp15, (unsigned int reg, unsigned int operant2, unsigned int data));
